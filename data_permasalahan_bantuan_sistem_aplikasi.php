                    ...
                    <div class="panel-heading">
                    	<div class="row">
                        	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Permasalahan Belum Terjawab Kategori Sistem Aplikasi</h3>
                            ...
                            <div class="col-lg-1 col-md-6 col-sm-6 col-xs-6">
								<div class="dropdown">
								  ...
								  <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
								    <li><a href="data_permasalahan_bantuan_lkpm.php">LKPM</a></li>
								    <li><a href="data_permasalahan_bantuan_sistem_aplikasi.php">Sistem Aplikasi </a></li>
								    <li><a href="data_permasalahan_bantuan_perizinan.php">Perizinan</a></li>
								    <li><a href="data_permasalahan_bantuan_non_sistem.php">Non Sistem</a></li>
								  </ul>
								</div>
                            </div>
                            <?php
...
$(document).ready(function(){
	...
	var userdataTable = $('#user_data').DataTable({
		...
		"order": [],
		"ajax":{
			url:"data_permasalahan_bantuan_fetch_sistem_aplikasi.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"data_permasalahan_bantuan_action_sistem_aplikasi.php",
			method:"POST",
	...
	$(document).on('click', '.delete', function(){
		...
		{
			$.ajax({
				url:"data_permasalahan_bantuan_action_lkpm.php",
				method:"POST",
