...
?>
                    ...
                    <div class="panel-heading">
                    	<div class="row">
                        	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Data Solusi Individual</h3>
                            </div>
        ...
        <div>       	
        		<form method="post" action="excel_solusi_individual.php" style="margin-left: 20px;">
...
$(document).ready(function(){
	...
	var userdataTable = $('#user_data').DataTable({
		...
		"order": [],
		"ajax":{
			url:"data_solusi_individual_fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			...
			success:function(data)
			{
				...
				$('.modal-body').html("<label>Permasalahan</label><br><input type='text' name='permasalahan' id='permasalahan' class='form-control' disabled><label>Solusi</label><br><input type='text' name='solusi' id='solusi' class='form-control'>");
