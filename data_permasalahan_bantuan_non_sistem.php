                    ...
                    <div class="panel-heading">
                    	<div class="row">
                        	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Permasalahan Belum Terjawab Kategori Non Sistem</h3>
...
$(document).ready(function(){
	...
	var userdataTable = $('#user_data').DataTable({
		...
		"order": [],
		"ajax":{
			url:"data_permasalahan_bantuan_fetch_non_sistem.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('click', '.update', function(){
		...
		$.ajax({
			url:"data_permasalahan_bantuan_action_non_sistem.php",
			method:"POST",
