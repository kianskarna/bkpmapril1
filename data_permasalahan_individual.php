...
?>
                    ...
                    <div class="panel-heading">
                    	<div class="row">
                        	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Data Permasalahan Individual</h3>
                            </div>
        ...
        <div>       	
										...
										<form method="post" action="excel_permasalahan_individual.php" style="margin-left: 20px;">
...
$(document).ready(function(){
	...
	var userdataTable = $('#user_data').DataTable({
		...
		"order": [],
		"ajax":{
			url:"data_permasalahan_individual_fetch.php",
			type:"POST"
		},
		"columnDefs":[
			{
