...
if(isset($_GET["pdf"]) && isset($_GET['order_id']))
{
	...
	$statement = $connect->prepare("
		SELECT * FROM data_kegiatan_dimulai INNER JOIN (user_details JOIN provinsi ON user_details.provinsi=provinsi.id_provinsi) ON data_kegiatan_dimulai.user_id=user_details.user_id WHERE kegiatan_dimulai_id = :kegiatan_dimulai_id 
	");
	$statement->execute(
		array(
