...
?>
                    ...
                    <div class="panel-heading">
                    	<div class="row">
                        	<div class="col-lg-10 col-md-10 col-sm-8 col-xs-6">
                            	<h3 class="panel-title">Update Data Solusi</h3>
                            </div>
                            <?php
        		...
        		<form method="post" id="user_form">
        			...
        			<div class="modal-body">
        				<div class="form-group">
							<label>Solusi</label>
							<input type="text" name="solusi" id="solusi" class="form-control" required />
						</div>
			
					</div>
						
        			<div class="modal-footer">
        				<input type="hidden" name="solusi_id" id="solusi_id" />
        ...
        <div>       	
        							...
        							<?php
										if($_SESSION["type"] == 'master')
										{
											echo '<form method="post" action="excel_solusi.php" style="margin-left: 20px;">
...
$(document).ready(function(){
	...
	var userdataTable = $('#user_data').DataTable({
		...
		"order": [],
		"ajax":{
			url:"data_solusi_fetch_update.php",
			type:"POST"
		},
		"columnDefs":[
			{
	...
	$(document).on('submit', '#user_form', function(event){
		...
		$.ajax({
			url:"data_solusi_action_update.php",
			method:"POST",
	...
	$(document).on('click', '.update', function(){
		var solusi_id = $(this).attr("id");
		var btn_action = 'fetch_single';
		$.ajax({
			url:"data_solusi_action_update.php",
			method:"POST",
			data:{solusi_id:solusi_id, btn_action:btn_action},
			dataType:"json",
			success:function(data)
			{
